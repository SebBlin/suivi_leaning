...
def init_unix_connection_engine(db_config):
    ...
    cloud_sql_connection_name = os.environ.get("CLOUD_SQL_CONNECTION_NAME")  or access_secret_version(secret_id='CLOUD_SQL_CONNECTION_NAME', project_id='979602309341')
